...
export default function Community() {
  ...
  if (!open) {
    ...
    return (
      <div style={{background:'linear-gradient(180deg,#0E0D0C 0%,#0A0908 40%,#0A0908 100%)',minHeight:'calc(100vh - 100px)',display:'flex',alignItems:'center',justifyContent:'center',padding:'28px'}}>
        {!hasTicket ? (
