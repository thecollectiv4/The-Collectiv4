...
const ARTISTS = {
  ...
  'pato-duran': {
    ...
    location: 'Houston, TX',
    bio: "House and techno DJ, founder of The Collectiv4, and the creative mind behind Ran By Artists. Pato built the collective from the ground up — the music, the venues, the visual direction, the platform. Every detail of the experience runs through him. Behind the decks, he plays for the room — not for the clip.",
    contributions: ['Founder — The Collectiv4', 'DJ — RBA Edition 001 & 002', 'Creative Direction — Events, Gallery & Brand', 'Platform — Collective World'],
    initial: 'P',
    accent: '#FFFFFF',
  },
  'diego-villasenor': {
    ...
    bio: "Founder of The Collectiv4 and creative director behind its visual identity. Diego bridges physical art with digital experience — from brand direction to platform design. His personal brand Visurelic reflects his approach: where visual culture meets the future.",
    contributions: ['Founder — The Collectiv4', 'Creative Director — Brand & Visual Identity', 'Artist — Digital & Mixed Media', 'European Expansion — Long-term Vision'],
    initial: 'D',
    accent: '#D4A040',
  },
  'madou': {
