...
const ARTISTS = {
  ...
  'pato-duran': {
    ...
    location: 'Houston, TX',
    bio: "House and techno DJ, founder of The Collectiv4, and the creative force behind Ran By Artists. Pato lives between the decks and the big picture — selecting records that move the room while building the entire ecosystem around it. From the music to the venue to the platform, his creative direction shapes every layer of the experience.",
    contributions: ['Founder — The Collectiv4', 'DJ — RBA Edition 001 & 002', 'Creative Direction — Events, Brand & Platform', 'Built Collective World — Digital Platform'],
    initial: 'P',
    accent: '#FFFFFF',
  },
  'diego-villasenor': {
    ...
    bio: "Founder of The Collectiv4 alongside Pato — the visual architect behind everything the collective puts into the world. Diego leads the visual direction, creative direction, and brand identity from concept to execution. From the flyers to the platform design to the physical space, nothing goes out without his eye on it. His personal brand Visurelic carries the same philosophy: where visual culture meets the future.",
    contributions: ['Founder — The Collectiv4 (alongside Pato)', 'Visual Direction — Brand, Media & Content', 'Creative Director — Event Design & Identity', 'Artist — Digital & Mixed Media', 'European Expansion — Long-term Vision'],
    initial: 'D',
    accent: '#D4A040',
  },
  'madou': {
