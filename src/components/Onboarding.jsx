...
/* ── LA TRAMPA DE FOCO ────────────────────────────────────────────────────
   Una receta, DOS consumidores (esta pantalla y <Tutorial/>), que es la
   regla de la casa contra la deriva (ver la cabecera de Chip.jsx: tres
   copias a mano del mismo chip terminaron siendo tres chips distintos). Vive
   aquí y no en src/lib porque hoy sólo la usan estas dos pantallas de
   primera vez; si aparece un tercer consumidor, se muda a su propio módulo.
